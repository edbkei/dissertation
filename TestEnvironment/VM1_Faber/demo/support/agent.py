...
DEFAULT_EXTERNAL_HOST = "143.106.73.51" #here, before localhost
DEFAULT_PYTHON_PATH = ".."
PYTHON = os.getenv("PYTHON", sys.executable)

START_TIMEOUT = float(os.getenv("START_TIMEOUT", 500.0))
...
if RUN_MODE == "docker":
    ...
    # DEFAULT_EXTERNAL_HOST = DEFAULT_INTERNAL_HOST  ## remove comment mark
    DEFAULT_PYTHON_PATH = "."
elif RUN_MODE == "pwd":
...
class DemoAgent:
    def __init__(
        ...
        **params,
        ...
        self.external_host = DEFAULT_EXTERNAL_HOST # here, before was external_host or DEFAULT_EXTERNAL_HOST
    ...
    async def register_schema_and_creddef(
        ...
        version,
        schema_attrs,
        support_revocation: bool = True,   # Here, before False
    ...
    async def service_decorator(self):
        ...
        print("agent_endpoint: ",agent_endpoint) # here
        decorator = {
