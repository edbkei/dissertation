 ...
 */
                ...
                //  read      <token>                                                     List specific token asset.                                                     //
                //  reado     <token>        <owner>                                      List specific token asset of a specific owner.                                 //
                //  create    <token>        <FinalConsumer>  <EnergyKWH>                 Create one asset. Token ID, final consumer, energy (KWH)                       //
			...
			const contract = network.getContract(chaincodeName);
			   ...
			   console.log(`*** Result: ${prettyJSONString(result.toString())}`);
			         ...
			         console.log(`*** Result: ${prettyJSONString(result.toString())}`);
			          ...
			          console.log('\n--> Submit Transaction: CreateAsset, creates new asset with ID, FinalConsumer, EnergyKWH, Status, Owner, and appraisedValue, docType arguments');
			          await contract.submitTransaction('CreateAsset', args[1], args[2], args[3],args[4], args[5], args[6], args[7]);
			          console.log('*** Result: committed');
